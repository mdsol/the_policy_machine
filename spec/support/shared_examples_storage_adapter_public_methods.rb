...
shared_examples 'a policy machine storage adapter with required public methods' do
  ...
  required_public_methods += %w[assign connected? unassign delete update element_in_machine? add_association
                                associations_with policy_classes_for_object_attribute transaction]
