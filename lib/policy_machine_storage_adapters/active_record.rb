  ...
  class ActiveRecord
    ...
    def is_privilege?(user_or_attribute, operation, object_or_attribute)
      ...
      if policy_classes_containing_object.size < 2
        !accessible_operations(user_or_attribute, object_attribute_ids, operation_id).empty?
      else
    ...
    def is_filtered_privilege?(user_or_attribute, operation, object_or_attribute, filters: {}, options: {})
      ...
      if policy_classes_containing_object.size < 2
        !accessible_operations(user_or_attribute, object_attribute_ids, operation_id, filters: filters).empty?
      else
