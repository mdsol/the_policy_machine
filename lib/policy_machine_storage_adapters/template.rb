...
module PolicyMachineStorageAdapter
  class Template
    ...
    # * persisted
    #
    def add_user(unique_identifier, policy_machine_uuid, extra_attributes = {}); end

    def add_user_attribute(unique_identifier, policy_machine_uuid, extra_attributes = {}); end

    def add_object(unique_identifier, policy_machine_uuid, extra_attributes = {}); end

    def add_object_attribute(unique_identifier, policy_machine_uuid, extra_attributes = {}); end

    def add_operation(unique_identifier, policy_machine_uuid, extra_attributes = {}); end

    def add_operation_set(unique_identifier, policy_machine_uuid, extra_attributes = {}); end

    def add_policy_class(unique_identifier, policy_machine_uuid, extra_attributes = {}); end
    ...
    # be returned.
    #
    def find_all_of_type_user(options = {}); end

    def find_all_of_type_user_attribute(options = {}); end

    def find_all_of_type_object(options = {}); end

    def find_all_of_type_object_attribute(options = {}); end

    def find_all_of_type_operation(options = {}); end

    def find_all_of_type_operation_set(options = {}); end

    def find_all_of_type_policy_class(options = {}); end
    ...
    #
    def add_association(user_attribute, object_attribute); end
    ...
    #
    def associations_with(operation); end
    ...
    def scoped_privileges(user_or_attribute, object_or_attribute); end

    # Optimized version of PolicyMachine#accessible_objects
    # Return all objects the user has the given operation on
    # Optional: only add this method if you can do it better than policy_machine.rb
    def accessible_objects(user_or_attribute, operation, options = {}); end
  end
end
